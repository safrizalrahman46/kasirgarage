            ...
            {{-- <div class="table-responsive">
                ...
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $nilai->siswa_id ? $nilai->siswa->nama : 'Tidak Punya Siswa' }} </td>

                            {{-- @dd($nilai->mapel) --}}

                            <td>{{ $nilai->mapel_id ? $nilai->mapel->nama_mapel : 'Tidak Punya Mapel'}} </td>
                            <td>{{ $nilai->nilai }} </td>
                            <td> <a href="/nilai/{{ $nilai->id }}/delete" class="btn btn-danger" onclick="return confirm('APAKAH ANDA YAKIN? {{ $nilai->nama }}');">HAPUS</a>
