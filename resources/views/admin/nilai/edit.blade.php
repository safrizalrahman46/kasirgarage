    ...
    <form action="/nilai/{{ $nilais->id }}/update" method="POST">
        ...
        <div class="mb-2">
            ...
            <select  name="siswa_id" id="" class="custom-select rounded-0">
                ...
                <option value="{{ $sis->id }}"  @selected($sis->id == $nilais->siswa->id) >{{ $sis->nama }}</option>
              @endforeach
          ...
          <div class="form-select mb-2">
            ...
            {{-- @dd($nilais) --}}
              <select  name="mapel_id" id="" class="custom-select rounded-0">
                  ...
                  <option value="{{ $pel->id }}"  @selected($pel->id == $nilais->mapel->id) >{{ $pel->nama_mapel }}</option>
                @endforeach
            </optgroup>
        ...
        <div class="form-label">
          ...
          <input type="number" name="nilai" placeholder="nilai" value="{{ $nilais->nilai }}" class="form-control" id="exampleInputEmail1" >
        </div>
